        ...
        <section class="content"> <!-- .box-body -->
            <div class="box box-primary">
                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            总共${pageBean.totalPage}页，共${pageBean.totalSize}条数据。 每页
...
<script type="text/javascript">
    ...
    function gotoPage(num) {
        ...
        location.href="${pageContext.request.contextPath}/product/findByPage?pageNum="+num+"&pageSize="+pageSize;
    }
    /**
     * #pageSize: select 的id
     * option: 里面所有的选项
     * [value=${pageBean.pageSize}] : 选择值相同的选项（option选项中必须指定value）
     * prop: 给选项指定属性值
     */
