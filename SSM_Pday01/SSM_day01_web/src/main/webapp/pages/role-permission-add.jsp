...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form
				action="${pageContext.request.contextPath}/role/saveRolePermission"
				method="post">
				<!-- 正文区域 -->
					...
					<table id="dataList"
							...
							<tbody>
								<c:forEach items="${permissionList}" var="permission">
									<tr>
										<td><input name="ids" type="checkbox" ${fn:contains(rolePermissionList, ",".concat(permission.id).concat(","))?"checked":""}  value="${permission.id}"></td>
										<td>${permission.id}</td>
