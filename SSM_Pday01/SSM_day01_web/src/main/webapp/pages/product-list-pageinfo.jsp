            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="table-box">
                        ...
                        <!--工具栏/-->
                        <form id="delForm" action="${pageContext.request.contextPath}/product/delSelected">
                            <!--数据列表-->
                            <table id="dataList"
                                ...
                                <tr>
                                    ...
                                    <th class="sorting_asc">${product.id}</th>
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <a href="javascript:gotoPage(${pageInfo.prePage})">上一页</a>
                                </c:otherwise>
                            </c:choose>
                            </li>
...
<script type="text/javascript">
    ...
    function gotoPage(num) {
        ...
        if (num>${pageInfo.pages}){
            num=${pageInfo.pages};
            alert('没有下一页了');
        }
        location.href="${pageContext.request.contextPath}/product/findByPageInfo?pageNum="+num+"&pageSize="+pageSize;
    }
    /**
     * #pageSize: select 的id
     * option: 里面所有的选项
     * [value=${pageInfo.pageSize}] : 选择值相同的选项（option选项中必须指定value）
     * prop: 给选项指定属性值
     */
